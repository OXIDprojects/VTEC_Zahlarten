...
<tr>
            ...
            <tr>
                <td class="edittext">
                [{ oxmultilang ident="VTEC_ADMIN_ZUBONI" }]
                </td>
                <td class="edittext">
                <input type="text" class="editinput" size="25" maxlength="[{$edit->oxpayments__vtectoboni->fldmax_length}]" name="editval[oxpayments__vtectoboni]" value="[{$edit->oxpayments__vtectoboni->value}]" [{ $readonly }]>
                [{ oxinputhelp ident="HELP_VTEC_ZUBONI" }]
                </td>
            </tr>
            [{* Ende neuer Block *}]
            <tr>
